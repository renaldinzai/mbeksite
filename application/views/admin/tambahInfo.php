  ...
  <div id="main">
    <div class="container">
      ...
      <div class="container" style="margin-top:50px;">
        <h2 style="text-align: left;">Tambah Info</h2>
        <?php echo form_open_multipart('myadmin/blog/addInfo');?>
        <div class="row">
          <div class="col-sm-6">
            <div class="form-group">
              ...
              <br>
              <label>Konten:</label>
              <textarea class="form-control" id="konten" name="konten" placeholder="Tulis sesuatu yang menarik.."></textarea>
            </div>
          </div>
          <div class="col-sm-6">
            <div class="form-group">

...
<head>
  ...
  <title>Daftar Investasi Kandang</title>
...
<body>
  ...
  <div id="main">
    ...
    <h2 style="text-align: left;">Investasi Kandang</h2>
  <table class="table table-bordered table-striped">
    <thead>
      <tr>
        <th class="text-center">No.</th>
        <th class="text-center">Alamat Ternak</th>
      ...
      ?>
        ...
        foreach ($mydata as $row) {
          ...
          <tr>
            ...
            <td class="text-center"><?php echo $row->alamaternak ?></td>
            <td class="text-center"><?php echo $row->jumlahternak ?></td>
            <td class="text-center"><?php echo $row->durasi ?></td>
            <td class="text-center"><?php echo $row->status ?></td>
            <td class="text-center">
              <a href="<?php echo site_url('myadmin/invKandang/pilih/'.$row->id_invKandang) ?>" class="btn btn-warning">Edit</a>
              <a href="<?php echo site_url('myadmin/invKandang/hapus/'.$row->id_invKandang) ?>" class="btn btn-danger" onclick="return confirm('Apakah Anda yakin?')">Hapus</a>
            </td>
          </tr>
          <?php
        }

...
<head>
  ...
  <title>Edit Investasi Kambing</title>
  ...
  <div id="main">
    <div class="container">
      ...
      <div class="container" style="margin-top:50px;">
        ...
        <?php echo form_open_multipart('myadmin/invKambing/update');?>
        <div class="row">
          <div class="col-sm-6">
            <div class="form-group"> 
              <label>ID Investasi:</label>
              <input type="text" name="id_invKambing" id="id_invKambing" class="form-control" value="<?php echo $id_invKambing?>" readonly/><br>
              <label>Jenis:</label>
              <input type="text" class="form-control" id="jenis" name="jenis" value="<?php echo $jenis ?>" readonly><br>
              <label>Banyak:</label>
              <input class="form-control" id="banyak" name="banyak" value="<?php echo $banyak ?>" readonly/>
            </div>
          </div>
          <div class="col-sm-6">
            <div class="form-group">

...
<head>
  ...
  <title>Edit Daftar Qurban</title>
  ...
  <div id="main">
    <div class="container">
      ...
      <div class="container" style="margin-top:50px;">
        <h2 style="text-align: left;">Edit Data Qurban</h2>
        <?php echo form_open_multipart('myadmin/qurban/update');?>
        <div class="row">
          <div class="col-sm-6">
            <div class="form-group"> 
              <label>ID Qurban:</label>
              <input type="text" name="id_qurban" id="id_qurban" class="form-control" value="<?php echo $id_qurban?>" readonly/><br>
              <label>Jenis:</label>
              <input type="text" class="form-control" id="jenis" name="jenis" value="<?php echo $jenis ?>" readonly><br>
              <label>Tujuan:</label>
              <input class="form-control" id="tujuan" name="tujuan" value="<?php echo $tujuan ?>" readonly/><br>
              <label>Pesan:</label>
              <input class="form-control" id="pesan" name="pesan" value="<?php echo $pesan ?>" readonly/>
            </div>
          </div>
          <div class="col-sm-6">
            <div class="form-group">

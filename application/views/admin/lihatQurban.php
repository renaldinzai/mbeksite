      ...
      ?>
        ...
        foreach ($mydata as $row) {
          ...
          <tr>
            ...
            <td class="text-center"><?php echo $row->pesan ?></td>
            <td class="text-center"><?php echo $row->status ?></td>
            <td class="text-center">
              <a href="<?php echo site_url('myadmin/qurban/pilih/'.$row->id_qurban) ?>" class="btn btn-warning">Edit</a>
              <a href="<?php echo site_url('myadmin/qurban/hapus/'.$row->id_qurban) ?>" class="btn btn-danger" onclick="return confirm('Apakah Anda yakin?')">Hapus</a>
            </td>
          </tr>
          <?php
        }

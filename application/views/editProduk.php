  ...
  <div class="row">
    <div class="col-sm-6">
      <div class="form-group">
        ...
        <input type="text" name="id_prd" id="id_prd" class="form-control" value="<?php echo $id_prd ?>" readonly/>
      </div>
    </div>
    <div class="col-sm-6">
      <div class="form-group">
        <label>Nama Produk:</label>
        <input type="text" class="form-control" id="nama_prd" name="nama_prd" value="<?php echo $nama_prd ?>">
      </div>
    </div>
    <div class="col-sm-6">
      <div class="form-group">
        <label>Kategori:</label>
        <select class="form-control" id="kategori" name="kategori_prd" value="<?php echo $kategori_prd ?>">
    ...
    <div class="col-sm-6">
      <div class="form-group">
        <label>Stok:</label>
        <select class="form-control" id="stok" name="stok" value="<?php echo $stok ?>">
          <option>1</option>
          <option>2</option>
          <option>4</option>
          <option>5</option>

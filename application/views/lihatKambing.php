...
<body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="50">
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="myNavbar">
        <ul class="nav navbar-nav navbar-right">
          <li><a href="<?php echo base_url('index.php/investasi/tambahKambing'); ?>">TAMBAH INVESTASI KAMBING</a></li>
  ...
  <div class="container">
  <h2 style="text-align: center;">Investasi Kambing Saya</h2>
      ...
      ?>
        ...
        foreach ($mydata as $row) {
          ...
          <tr>
            ...
            <td><?php echo $row->banyak ?> ekor</td>

...
<body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="50">
  ...
  <div class="container" style="margin-top:50px;">
    <h2 style="text-align: center;">PRODUK SAYA</h2>
  <p>
    <a href="<?php echo site_url('produk/do_tambah') ?>" class="btn btn-primary">Tambah Produk</a>
  </p>
      ...
      ?>
        ...
        foreach ($mydata as $row) {
          ...
          <tr>
            ...
            <td><?php echo $row->kategori_prd ?></td>
